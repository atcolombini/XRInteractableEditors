...
namespace Inno.XR
{
    ...
    /// </summary>
    [CustomEditor(typeof(XRCustomGrabInteractable), true), CanEditMultipleObjects]
    public class XRCustomGrabInteractableEditor : XRCustomInteractableEditor
    {
        // Added to allow drawing only the properties of child classes' instances in Inspector
        protected string[] grabPropertiesInBaseClass = new string[]
        {
            "m_Script",
        ...
        {
            base.propertiesInBaseClass = this.grabPropertiesInBaseClass;
            base.DrawChildProperties();
        }
